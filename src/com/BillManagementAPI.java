...
public class BillManagementAPI extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
			throws ServletException, IOException {
		String output = projectObj.insertProject(request.getParameter("cusID"), 
				request.getParameter("noOfWatts"),
	...
	protected void doDelete(HttpServletRequest request, HttpServletResponse response)
		...
		String output = projectObj.deleteProject(paras.get("billID").toString());
